...
@baseline_registry.register_trainer(name="semexpmodular")
class PredSemSemExpModularTrainer(BaseRLTrainer):
    r"""Trainer class for predicted semantic map similar to the modular approach in 
