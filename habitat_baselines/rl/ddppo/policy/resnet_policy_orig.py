...
from habitat_baselines.rl.ddppo.policy import resnet_orig as resnet
from habitat_baselines.rl.ddppo.policy.running_mean_and_var_orig import (
    RunningMeanAndVar,
)
from habitat_baselines.rl.models.rnn_state_encoder_orig import (
...
class DdppoPointNavResNetPolicy(Policy):
    def __init__(
        self,
...
class DdppoPointNavResNetNet(Net):
