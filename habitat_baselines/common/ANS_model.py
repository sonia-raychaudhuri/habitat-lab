...
from habitat_baselines.common.ans_utils.distributions import DiagGaussian
from habitat_baselines.common.ans_utils.model import get_grid, ChannelPool, Flatten, NNBase
...
class Global_Policy(NNBase):
    ...
    def __init__(self, input_shape, recurrent=False, hidden_size=512,
        ...
        out_size = int(int(input_shape[1] / 16.) * int(input_shape[2] / 16.))
    ...
    def forward(self, inputs, rnn_hxs, masks, extras):
        x = self.main(inputs)
        orientation_emb = self.orientation_emb(extras)
...
class RL_Policy(nn.Module):
    ...
    def __init__(self, obs_shape, action_space, model_type=0,
        ...
        if action_space.__class__.__name__ == "Discrete":
            ...
            self.dist = Ans_Categorical(self.network.output_size, num_outputs)
