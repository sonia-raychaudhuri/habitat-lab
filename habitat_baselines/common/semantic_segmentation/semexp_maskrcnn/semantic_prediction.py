...
from habitat_baselines.common.semantic_segmentation.semexp_maskrcnn.utils import filter_depth, overlay_masks

from habitat_baselines.common.semantic_segmentation.semexp_maskrcnn.coco_categories import coco_categories, coco_categories_mapping
...
class SemanticPredMaskRCNN():
    ...
    def __init__(
        ...
        config_path = "habitat_baselines/common/semantic_segmentation/semexp_maskrcnn/COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml"
        string_args = f"""
    ...
    def predict(
        ...
        obs["semantic_frame"] = visualizations[0].get_image()
        ...
        if len(relevant_masks) > 0:
            ...
            semantic_map, instance_map, score_map = overlay_masks(
                masks, class_idcs, scores, (height, width)
            )
        else:
        ...
        obs["semantic"] = semantic_map.astype(int)
        obs["instance_map"] = instance_map
        obs["instance_classes"] = class_idcs
        obs["instance_scores"] = scores
